    ...
    <div class="w-full max-w-4xl">
      ...
      <div class="bg-white rounded-3xl shadow-xl overflow-hidden transition-all duration-300 border border-black ">
        ...
        <div class=" p-8 text-center">
          <h1 class="text-4xl font-bold  ">Ajouter un utilisateur</h1>

        </div>
   <form class="space-y-6 p-12 " action="{{ route('userspost') }}" method="POST">
          @csrf
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="animate-fade-in">
             ...
             <div class="animate-fade-in">
              <label class="block text-gray-700 font-medium mb-2">Stock Atrribue</label>
            ...
            <div class="animate-fade-in">
              ...
              <select type="text" name="Role"
                  ...
                  <option name="1">Administrateur</option>

                    <option name="0">Utilisateur</option>
                    </select>
                    </div>
          </div>
        ...
        <div class="p-6">
              ...
              <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                  <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Stock en charge</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  <tr class="hover:bg-gray-50 transition duration-150 animate-fade-in">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-gray-500">{{ $user->stockatribue }}</td>
                   <td class="px-6 py-4 whitespace-nowrap text-gray-500">{{ $user->isadmin== 1? "Administrateur":"Utilisateur" }}</td>
          ...
          @else
            <div class="text-center py-12 bg-gray-50 rounded-lg">
              ...
              <h3 class="mt-4 text-lg font-medium text-gray-700">Aucun utilisateur enregistré</h3>
